...
Search, reports, dashboards, and saved views use the same pipeline, including RowPolicy filters. Unauthorized search hits, report fields, dashboard widgets, and saved views are denied or skipped. Audit widgets remain Admin-only.
