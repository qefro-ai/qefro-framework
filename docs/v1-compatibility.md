...
Qefro Framework **1.0.0** is a stable, production-ready release. This document is the compatibility contract. Anything marked **Stable** will not change incompatibly without a new major version. Current crate/runtime is **1.1.0** (identity foundation); apps still declare `framework_version = ">=1.0,<2.0"`.

Current versions:

| Surface | Version |
| --- | --- |
| Qefro Framework | `1.1.0` (`FRAMEWORK_VERSION`) |
